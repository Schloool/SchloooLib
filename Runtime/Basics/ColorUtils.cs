...
{
    /// <summary>Utility class to get and utilize colors from Unity context.</summary>
    public class ColorUtils
    {
        /// <summary>Gets the subtractive mixed <see cref="Color" /> of all colors the <see cref="SpriteRenderer" />'s <see cref="Sprite" /> contains.</summary>
        ...
        /// <summary>Gets the subtractive mixed <see cref="Color" /> of all colors the <see cref="Sprite" /> contains.</summary>
        ...
        /// <summary>Gets all <see cref="Color" />s a <see cref="SpriteRenderer" />s <see cref="Sprite" /> contains.</summary>
        /// <param name="spriteRenderer">The <see cref="SpriteRenderer" /> which will be used to get the colors of its <see cref="Sprite" />.</param>
        /// <param name="uniqueColorsOnly">Specifies whether all or only unique colored pixels will be taken into consideration.</param>
        ...
        /// <summary>Gets all <see cref="Color" />s a <see cref="Sprite" /> contains.</summary>
        ...
        /// <summary>Calculates the subtractive mixed <see cref="Color" /> from a multitude of colors.</summary>
